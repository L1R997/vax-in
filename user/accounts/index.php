<?php
date_default_timezone_set("Asia/Manila"); // Set timezone for accurate greeting
include '../../config.php';
                ...
                <div class="container-fluid pt-4">
                    ...
                    <div class="welcome-banner">
                        ...
                        <div class="row align-items-center banner-content">
                            <div class="col-md-8">
                                ...
                                <p class="mb-0" style="font-size: 1.1rem; opacity: 0.9;">Welcome back to your MAO Mogpog
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="list_barangay_animals" class="kpi-link"
                                title="Click to view animals by barangay">
                                <div class="card border-left-agri-dark shadow h-100 py-2 hover-card bg-white">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <div style="background: #e9f5e9; padding: 15px; border-radius: 50%;">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="vaccination_status" class="kpi-link"
                                title="Click to view vaccination percentages">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7 mb-4">
                            <div class="card shadow mb-4 h-100" style="border-radius: 15px;">
                                <div class="card-header py-3 bg-white" style="border-radius: 15px 15px 0 0;">
                                    <h6 class="m-0 font-weight-bold text-agri-dark"><i
                                            class="fas fa-chart-bar mr-2"></i>Vaccination Coverage by Barangay (Top 5)
                                    </h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-5 mb-4">
                            <div class="card shadow mb-4 h-100" style="border-radius: 15px;">
                                <div class="card-header py-3 bg-white" style="border-radius: 15px 15px 0 0;">
                                    <h6 class="m-0 font-weight-bold text-agri-dark"><i
                                            class="fas fa-chart-pie mr-2"></i>Registered Animals</h6>
                                </div>
                                <div class="card-body">
